...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-8 left-8 z-50 flex items-center gap-3 px-5 py-3 rounded-full bg-[#25D366] text-white font-semibold shadow-lg hover:scale-105 hover:shadow-xl transition-all duration-300 group"
